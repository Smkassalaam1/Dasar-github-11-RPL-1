...
< class="container">
  ...
  <form method ="POST" action = "">
    ...
    <h3><font face= "Times New Roman">Menu Makanan & Minuman di Restoran</font></h3>
  ...
  if (isset($_POST ['save'])){
    ...
    if ($pilih){
        for($pesan = 1; $pesan <= $pilih; $pesan++){
            ...
            echo "<tr>";
            echo "<br>";
            echo "Pesanan Ke-$pesan ";
            echo "<td>Pilih Paket : </td>";
            echo "<td><input type=text name=pilih[] value=></td>";
            echo "</tr>";

            echo "<tr>";
            echo "<td>Harga : </td>";
            echo "<td><input type=number name=harga[] value=></td>";
            echo "<br>";
            echo "</tr>";
